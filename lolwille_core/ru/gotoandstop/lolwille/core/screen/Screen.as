package ru.gotoandstop.lolwille.core.screen{
	...
	import ru.gotoandstop.lolwille.core.screen.events.ScreenEvent;
	import ru.gotoandstop.lolwille.core.ui.UIElement;
	
	[Event(name="enabled", type="ru.gotoandstop.lolwille.core.screen.events.ScreenEvent")]
	[Event(name="disabled", type="ru.gotoandstop.lolwille.core.screen.events.ScreenEvent")]
